...
public class Persona {
     ...
     * @throws PersonaIncorrectoException 
     */
    public Persona() throws PersonaIncorrectoException {
        this("", 0, SEXO_DEF, 0, 0);
    }
     ...
     * @throws PersonaIncorrectoException 
     */
    public Persona(String nombre, int edad, char sexo) throws PersonaIncorrectoException {
     ...
     * @throws PersonaIncorrectoException 
     */
    public Persona(String nombre, int edad, char sexo, double peso, double altura) throws PersonaIncorrectoException {
    	if (nombre == null || edad<0 || peso<0 || altura<0)
    			throw new PersonaIncorrectoException();
